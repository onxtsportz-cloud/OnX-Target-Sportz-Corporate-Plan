...
export default function App() {
  return (
    <div className="min-h-screen bg-[#f9fafb] text-[#1f2937] font-sans selection:bg-[#052e16] selection:text-white print:bg-white">
          ...
          <div className="flex items-center">
            <div className="flex items-center justify-center shrink-0 p-2">
              <img 
                ...
                className="w-auto h-24 sm:h-32 object-contain drop-shadow-md" 
                onError={(e) => {
      ...
      <main className="pt-32 sm:pt-48 pb-16 print:pt-4 print:pb-0">
        {/* Print Only Logo header */}
        <div className="hidden print:flex justify-center mb-8">
          <img src="/logo.png" className="h-40 object-contain drop-shadow-sm" alt="ONX Target Sportz" />
        </div>
        {/* ---------------- HERO & WELCOME ---------------- */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 print:py-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center print:block print:space-y-8">
            ...
            >
              <h1 className="text-5xl sm:text-6xl font-bold text-[#052e16] tracking-tight mb-6 print:text-4xl print:text-center">
                Aim for Excellence
              </h1>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-xl print:text-center print:max-w-none print:mb-8">
                Premium target sports experiences designed for teams. Sharpen discipline, 
                absolute concentration, and team synergy in a safe, guided environment.
              </p>
              ...
              <div className="space-y-6 print:grid print:grid-cols-3 print:space-y-0 print:gap-6">
                <div className="flex gap-4 print:flex-col print:items-center print:text-center">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#1f2937]">Elite Corporate Team Building</h3>
                  </div>
                </div>
                <div className="flex gap-4 print:flex-col print:items-center print:text-center">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#f2f8f5] rounded-full flex items-center justify-center print:bg-transparent">
                    <Crosshair className="w-6 h-6 text-[#052e16]" />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-[#1f2937]">Our Core Focus</h3>
                  </div>
                </div>
                <div className="flex gap-4 print:flex-col print:items-center print:text-center">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#f2f8f5] rounded-full flex items-center justify-center print:bg-transparent">
            ...
            <motion.div
              ...
              className="relative h-[400px] sm:h-[500px] rounded-3xl overflow-hidden bg-[#052e16] shadow-2xl print:h-[250px] print:rounded-2xl print:shadow-none print:break-inside-avoid print:mt-12"
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white print:bottom-6 print:left-6 print:text-center text-center sm:text-left">
                <p className="text-2xl font-bold mb-2">Corporate Readiness</p>
                <p className="text-white/90 text-lg">Focus under pressure. Deliver with precision.</p>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 print:block print:space-y-12">
              ...
              >
                ...
                <div className="space-y-8 print:space-y-6">
                  <div className="group print:text-center">
                    <h4 className="text-xl font-bold text-[#1f2937] flex items-center gap-2 print:justify-center">
                      <span className="w-2 h-2 rounded-full bg-[#dc2626] group-hover:scale-150 transition-transform"></span>
                      Olympic Spec Rifle
                    </h4>
                    <p className="text-gray-600 mt-2 ml-5 text-lg print:ml-0">Built completely for elite precision.</p>
                  </div>
                  <div className="group print:text-center">
                    <h4 className="text-xl font-bold text-[#1f2937] flex items-center gap-2 print:justify-center">
                      <span className="w-2 h-2 rounded-full bg-[#dc2626] group-hover:scale-150 transition-transform"></span>
                    ...
                    <p className="text-gray-600 mt-2 ml-5 text-lg print:ml-0">Equipped natively with a Red Dot Sight.</p>
                  </div>
                  <div className="group print:text-center">
                    <h4 className="text-xl font-bold text-[#1f2937] flex items-center gap-2 print:justify-center">
                      <span className="w-2 h-2 rounded-full bg-[#dc2626] group-hover:scale-150 transition-transform"></span>
                    ...
                    <p className="text-gray-600 mt-2 ml-5 text-lg print:ml-0">Ultimate distance accuracy with a 12x Scope.</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-[#052e16] rounded-3xl p-8 sm:p-10 text-white shadow-xl relative overflow-hidden print:shadow-none print:border-2 print:border-[#052e16] print:text-black print:bg-white print:p-6">
                  ...
                  <div className="space-y-6 relative z-10">
                    <div className="flex justify-between items-end border-b border-white/20 pb-4 print:border-gray-200">
                      <div>
                      ...
                      <div className="text-2xl font-bold text-white print:text-[#052e16]">₹499 <span className="text-sm font-normal text-green-200 print:text-gray-600">/ person</span></div>
                    </div>
                    ...
                    <div className="flex justify-between items-end border-b border-white/20 pb-4 print:border-gray-200">
                      ...
                      <div className="text-2xl font-bold text-white print:text-[#052e16]">₹849 <span className="text-sm font-normal text-green-200 print:text-gray-600">/ person</span></div>
                    </div>
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <div className="text-2xl font-bold text-white print:text-[#052e16]">₹999 <span className="text-sm font-normal text-green-200 print:text-gray-600">/ person</span></div>
                    </div>
                  </div>
      ...
      <footer className="bg-[#052e16] border-t border-[#dc2626] py-12 text-center text-green-100/60 flex flex-col items-center print:hidden">
        <div className="flex items-center justify-center mb-6">
          <div className="bg-white rounded p-3 flex items-center justify-center h-20 shadow-lg">
            <img 
              src="/logo.png" 
              alt="ONX Target Sportz" 
